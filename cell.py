                        ...
                        if cell.element == 'sand':
                            if neighbours['bottom'].element == 'air':
                                ...
                                nextgen[i][j+1].element = 'sand'
                                    ...
                                    (neighbours[   'bottom'   ].element == 'wall' or neighbours['bottom'].element == 'sand')
                        ...
                        if cell.element == 'fluid':
                            ...
                            if neighbours['bottom'].element == 'air':
                                ...
                                nextgen[i][j+1].element = 'fluid'
                                    ...
                                    (neighbours[   'bottom'   ].element == 'wall' or neighbours[   'bottom'  ].element == 'sand' or neighbours['bottom'].element == 'fluid')
